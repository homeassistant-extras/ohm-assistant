...
_Modern energy monitoring and power consumption visualization for Home Assistant_

![Ohm Assistant Card](assets/card.png)
...
- Maintained by [Patrick Masters](https://github.com/warmfire540) / [Curious Cat Consulting](https://curiouscat.consulting/projects/ha-ohm-assistant?utm_source=github-ohm-assistant&utm_medium=readme&utm_campaign=oss-presence&utm_content=maintained-by)
